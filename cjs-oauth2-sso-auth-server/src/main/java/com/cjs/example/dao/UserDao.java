...
public class UserDao {
...

    {
        ...
        developer.setPermissionList(Collections.singletonList(p1));
    ...
    public SysUser selectByName(String username) {
        ...
        if ("zhangsan".equals(username)) {
            SysUser sysUser = new SysUser("zhangsan", "$2a$10$UU22OOXc0ivPIjYYgEwcjuzy.8mDMhgQgro.2UVT7r8LJhc2tEKhm");
            sysUser.setRoleList(Arrays.asList(admin, developer));
            return sysUser;
        }else if ("lisi".equals(username)) {
            SysUser sysUser = new SysUser("lisi", "$2a$10$UU22OOXc0ivPIjYYgEwcjuzy.8mDMhgQgro.2UVT7r8LJhc2tEKhm");
            sysUser.setRoleList(Collections.singletonList(developer));
            return sysUser;
        }
        return null;
    }
